    ...
    <div style={{ backgroundColor: 'white', borderBottom: '1px solid #e5e7eb', padding: '1rem 1.5rem' }}>
      <div style={{ maxWidth: '1216px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          {/* Primeira linha - Filtro de ordenação */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ position: 'relative', width: '100%' }}>
              ...
              <div style={{ position: 'absolute', top: 0, bottom: 0, right: 0, display: 'flex', alignItems: 'center', paddingRight: '0.75rem', pointerEvents: 'none' }}>
                <ChevronDown style={{ height: '1.25rem', width: '1.25rem', color: '#0175a6' }} />
              </div>
            </div>
          </div>

          {/* Segunda linha - Botão de Filtros */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem' }}>
            ...
            >
              <Filter style={{ height: '1.125rem', width: '1.125rem' }} />
              {hasActiveFilters ? 'Filtros Ativos' : 'Filtros'}
            </button>
